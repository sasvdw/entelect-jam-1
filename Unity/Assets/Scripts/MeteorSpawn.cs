...
{
    public Transform[] Meteors = new Transform[0];
	...
	void Start ()
	{
	    ...
	    {
	        throw new UnityException("No Meteors loaded for the Meteor spawn!");
	    }
        ...
        Debug.Log(cameraBounds.Left);
        Debug.Log(cameraBounds.Right);
        Debug.Log(cameraBounds.Top);
        Debug.Log(cameraBounds.Bottom);
